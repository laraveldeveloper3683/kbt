...
@section('content')
    <div class="page-wrapper">
        <div class="container-fluid">
            <form class="vendorRequestForm" method="post" action="/customer/vendor-order-request/submit"
                    ...
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active"><a href="/customer/vendor-order-request">Vendor
                                        Request
                                        Order</a></li>
                            </ol>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title" style="text-align: center;">
                                            {{ isset($VaseType) && $VaseType->pk_vase_type ? 'Edit Vase Type' : 'Create New Vendor Order Request' }}
                                        </h4>
                                            ...
                                            <div id="navpills-1" class="tab-pane active">
                                                <div class="row">
                                                    ...
                                                    <div style="margin-left: 550px;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pk_locations" id="pk_locations"
                                                                ...
                                                                @if ($vendors)
                                                                    @foreach ($vendors as $item)
                                                                        <option value="{{ $item->pk_vendors }}"
                                                                            @if (old('pk_locations') == $item->pk_vendors) selected @endif>
                                                                            {{ $item->vendor_name }}</option>
                                                                    @endforeach
                                                                @endif
                                                                <option value="other"
                                                                    @if (request()->pk_locations == 'other') selected @endif>Other
                                                                </option>
                                                            </select>
                                                            @error('pk_locations')
                                                                <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <a href="/customer/vendor-order-request"><input
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content br-n pn">
                                            <div id="navpills-1" class="tab-pane active">
                                                ...
                                                <div class="row justify-content-center tempItemTbl" style="@if(!old('item_name')) display: none @endif">
                                                    <div class="col-lg-8">
