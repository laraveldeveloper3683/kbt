    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <ul class="navbar-nav onMobile pb-0">
                ...
                <li class="nav-item"><a href="#" class="nav-link"> <img class="cart" style="width:30px;"
                                                                        src="{{asset('home/images/cart.png')}}"/> </a>
                </li>
            </ul>
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav m-auto">
                    @if(Auth::check() && Auth::user()->pk_roles == 4)
                        ...
                        <li class="nav-item"><a href="{!! route('dashboard.myorders') !!}" class="nav-link">My
                                Orders</a></li>
                    ...
                    @if(Auth::check() && Auth::user()->pk_roles == 3)
                        <li class="nav-item"><a href="/locationmanager/vendor-order-request" class="nav-link">Vendor
                                Order Request</a></li>
                    @endif
                    @if(Auth::check() && Auth::user()->pk_roles == 2)
                        ...
                        <li class="nav-item"><a href="{{ route('accountadmin.sales.index') }}"
