                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="title">Address Type</label>
                                                        <select class="form-control" name="pk_address_type">
                                                          @foreach($customerAddress as $address_type)
                                                          <option value="{{$address_type->pk_address_type}}" {{isset($customer_address) && ($customer_address->pk_address_type == $address_type->pk_address_type) ? 'selected' : ''}}>{{$address_type->address_type}}</option>
                                                          @endforeach
                                                        </select>
                                                        @error('address')
