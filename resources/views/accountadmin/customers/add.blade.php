                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body2">
                                                <div class="table-responsive m-t-40">
                                                    @if(isset($customer) && !empty($customer->pk_customers))
                                                        <a href="/accountadmin/customers/family/add/{{$customer->pk_customers}}">
                                                            <button class="btn btn-danger text-white card-title"
                                                                    style="float: right;margin-right: 36px;margin-left: 20px;margin-top: 4px;">
                                                                Add Family
                                                            </button>
                                                        ...
                                                        @if(!empty($families))
                                                            @foreach($families as $family)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;">
                                                                        <a href="/accountadmin/customers/family/edit/{{$family->pk_customer_family }}">
                                                                            <button class="btn btn-danger text-white">
                                                                                Edit
                                                                            </button>
                                                                        </a>
                                                                        <a href="/accountadmin/customers/family/delete/{{$family->pk_customer_family}}">
                                                                            <button class="btn btn-danger text-white">
                                                                                Delete
                                                                            </button>
                                                                        </a>
