    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="text-align:center;">{{isset($state) && ($state->pk_states) ? 'Edit State' : 'Create New State'}}</h4>
                                          ...
                                          <form class="form-horizontal mt-4 " method="post" action="{{isset($state) && ($state->pk_states) ? '/superadmin/states/update' : '/superadmin/states/submit'}}">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Active</label>
                                                    ...
                                                    <input type="radio" name="active" value="0" {{ isset($state) && ($state->active=="0")? "checked" : "" }} class="form-check-input">
