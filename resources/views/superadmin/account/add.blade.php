                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content br-n pn">
                                      ...
                                      <div class="col-md-12">
                                            ...
                                            <div class ="row">
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" id="autocomplete" class="form-control" value="{{isset($account) && ($account->address)?$account->address:old('address')}}">
                                                </div>
                                              </div>
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="address_1">Ste#</label>
                                                    <input type="text" name="address_1" id="street_number" class="form-control @error('address_1') is-invalid @enderror" value="{{isset($account) && ($account->address_1)?$account->address_1:old('address_1')}}" maxlength="10">
                                                    @error('address_1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="city" id="locality" class="form-control" value="{{isset($account) && ($account->city)?$account->city:old('city')}}">
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="zip" id="postal_code" class="form-control" value="{{isset($account) && ($account->zip)?$account->zip:old('zip')}}">
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div id="navpills-2" class="tab-pane {{isset($account) && ($account->pk_account)?'active':''}}" style="display:none;">
                                      <div class="row">
                                        <form name="account-user" id ="account-user" class="form-horizontal mt-4" method="post" action="/superadmin/account/users/submit" style="margin-left: 550px;">
                                          @csrf
                                          <div class="form-group">
