    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title" style="text-align:center;">{{ isset($event) && ($event->pk_event) ? 'Edit Event':'Create New Event'}}</h4>
                                <div class="tab-content br-n pn">
                                    <div id="navpills-1" class="tab-pane active">
                                        <div class="row" style="margin-left:520px;">
                                          ...
                                          @endif
                                          <form class="form-horizontal mt-4 " method="post" action="/superadmin/event/submit">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ isset($event) && ($event->description) ?$event->description: old('description')}}">
                                                @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Active</label>
                                                    ...
                                                    <input type="radio" name="active" value="0" {{ isset($event) && ($event->active=="0")? "checked" : "" }}  class="form-check-input" >
                                            ...
                                            <a href="/superadmin/event/back"><input class="btn btn-primary" type="button" value="Cancel"></a>
