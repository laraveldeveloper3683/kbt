...
<section class="bgAll boxs">
    <div class="bgAllInner boxs">
        <h2 class="heading">{{$page_title}} Edit Business</h2>
         @if($business->status==5 || $business->status==2)
     <div class="delterBtn">
             <a href="javascript:void(0)" class="Btns colorRED"  data-toggle="modal" data-delete_id="{{$business->id}}" data-target="#deleteBusiness">Delete</a>
                            ...
                            <div class="detailExit">
                                ...
                                <div class="profileDeet padding-Top boxs">
                                    ...
                                    <div class="row padding-Top">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label>Website <span class="start_validation">*</span> @if(!empty($business->website)) <a href="{{$business->website}}" target="_blank" style="color:#0042b9;">(Click Here)</a> @endif</label>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Instagram @if(!empty($business->instagram)) <a href="{{$business->instagram}}" target="_blank" style="color:#0042b9;">(Click Here)</a> @endif</label>
...
<!--                                    </div>-->
                                ...
                                <!-- <button type="button" class="buttonType" value='Add more' id='addmore' class="add">Add more</button> -->
                                <div class="">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <!--  <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="branch_no[]" class="form-control" data-validation="required" data-validation-error-msg="Please enter branch no" value="{{$branche->branch_no}}">
                                                    </div>
                                                </div> -->
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                               ...
                                               <!--  <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label>County</label>
                                                        <input type="text" name="country[]" class="form-control" id="country_{{$i}}" data-validation="required" data-validation-error-msg="Please enter country" value="{{$branche->country}}">
                                                    </div>
                                                </div> -->
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                 ...
                                 <tbody>
                                   <tr>
                                     <td><label>Price</label>
                                       <input type="text" name="price" value="{{$business->price}}">
                                     </td>
                                   </tr>
                                 </tbody>
                               </table>
                             ...
                             <div class="col-sm-2" style="margin-right: 32px;">
                               <table class="table" style="border: 1px solid black;">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     <td colspan="2"><label>Comment:</label><span><textarea name="reviewer_comment_0">{{$business->reviewer_comment_0}}</textarea></span></td>
                                   </tr>
                                 </tbody>
                               </table>
                             </div>
                             <div class="col-sm-2" style="margin-right: 32px;">
                               <table class="table" style="border: 1px solid black;">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     <td colspan="2"><label>Comment:</label> <span><textarea name="reviewer_comment_1" >{{$business->reviewer_comment_1}}</textarea></span></td>
                                   </tr>
                                 </tbody>
                               </table>
                             </div>
                             <div class="col-sm-2" style="margin-right: 32px;">
                               <table class="table" style="border: 1px solid black;">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     <td colspan="2"><label>Comment:</label> <span><textarea name="reviewer_comment_2">{{$business->reviewer_comment_2}}</textarea></span></td>
                                   </tr>
                                 </tbody>
                               </table>
                             </div>
                             <div class="col-sm-2" style="margin-right: 32px;">
                               <table class="table" style="border: 1px solid black;">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     <td colspan="2"><label>Comment:</label> <span><textarea name="reviewer_comment_3">{{$business->reviewer_comment_3}}</textarea></span></td>
                                   </tr>
                                 </tbody>
                               </table>
                             </div>
                             <div class="col-sm-2" style="margin-right: 32px;">
                               <table class="table" style="border: 1px solid black;">
                                 ...
                                 <tbody>
                                   ...
                                   <tr>
                                     <td colspan="2"><label>Comment:</label> <span><textarea name="reviewer_comment_4">{{$business->reviewer_comment_4}}</textarea></span></td>
                                   </tr>
                                 </tbody>
                               </table>
                             </div>
                        ...
                        <table class="table">
                            ...
                            <tbody id="menue_result">
                                ...
                                <tr id="row_{{$menu->id}}">
                                    ...
                                    <td>{{Helper::formatDate($menu->updated_at) }}</td>
                     ...
                     <table id="myTable" class=" table order-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2">
                                        <input type="hidden" name="business_id" value="{{$business->id}}">
                                        <input type="text" name="start_time[]"  value="{{date('H:i A',strtotime($hh_hours->start_time))}}" class="form-control timepicker" placeholder="Start Time" data-validation="required" />
                                    </td>
                                    <td class="col-sm-2">
                                        <input type="text" name="end_time[]"  value="{{date('H:i A',strtotime($hh_hours->end_time))}}" class="form-control timepicker" placeholder="End Time" data-validation="required"/>
                                    </td>
                                    <td class="col-sm-3">
                                    ...
                                    <td class="col-sm-3"> <textarea class="form-control" name="drink[]" placeholder="Drink" data-validation="required">{{$hh_hours->drink}}</textarea>
                                     ...
                                     @if($x!=0)
                                    <td><input type="button" class="ibtnDel btn btn-md btn-danger"  value="Delete" onclick="delRow('{{$x}}')"></td>
                                    @endif
                                </tr>
                                @php $x++;@endphp
                                @endforeach
                                @else
                               <tr id="remove_row_0">
                                 <td colspan="6" class="allcol"><div><h2 class="heading">Quick Filters</h2></div><div>
                                   @if(count($filter)>0)
                                    @foreach($filter as $filters)
                                    <label><input type="checkbox" onchange="QuickFilters(this.value,0)" class="quickFilter_0" value="{{$filters->name}}">{{ucwords($filters->name)}}</label>
                                    @endforeach
                                    @endif
                                 ...
                                 <tr>
                                    ...
                                    <td class="col-sm-2">
                                        <input type="hidden" name="business_id" value="{{$business->id}}">
                                        <input type="text" name="start_time[]" class="form-control timepicker" placeholder="Start Time" data-validation="required"  autocomplete="off" />
                                    </td>
                                    <td class="col-sm-2">
                                        <input type="text" name="end_time[]"   class="form-control timepicker" placeholder="End Time" data-validation="required" autocomplete="off" />
                                    </td>
                                    <td class="col-sm-3">
                        ...
                        <table class="table">
                            ...
                            <tbody id="hh_menue_result">
                                ...
                                <tr id="row_{{$hh_menu->id}}">
                                    ...
                                    <td>{{Helper::formatDate($hh_menu->updated_at) }}</td>
                        ...
                        <table class="table">
                            ...
                            <tbody id="reverse_menue_result">
                                ...
                                <tr id="row1_{{$revers_menue->id}}">
                                    ...
                                    <td>{{Helper::formatDate($revers_menue->updated_at)}}</td>
                     ...
                     <table id="BrunchTbl" class=" table brunch_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2">
                                        <input type="hidden" name="business_id" value="{{$business->id}}">
                                        <input type="text" name="start_time[]"  value="{{date('H:i A',strtotime($brunch_hours->start_time))}}" class="form-control timepicker" placeholder="Start Time" data-validation="required" autocomplete="off" />
                                    </td>
                                    <td class="col-sm-2">
                                        <input type="text" name="end_time[]"  value="{{date('H:i A',strtotime($brunch_hours->end_time))}}" class="form-control timepicker" placeholder="End Time" data-validation="required" autocomplete="off" />
                                    </td>
                                    <td class="col-sm-3">
                        ...
                        <table class="table">
                            ...
                            <tbody id="brunch_menue_result">
                                ...
                                <tr id="row2_{{$brunch_menue->id}}">
                                    ...
                                    <td>{{Helper::formatDate($brunch_menue->updated_at) }}</td>
                     ...
                     <table id="MusicTbl" class=" table music_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2">
                                        <input type="hidden" name="business_id" value="{{$business->id}}">
                                        <input type="text" name="start_time[]"  value="{{date('H:i A',strtotime($music_hours->start_time))}}" class="form-control timepicker" placeholder="Start Time" data-validation="required" autocomplete="off" />
                                    </td>
                                    <td class="col-sm-2">
                                        <input type="text" name="end_time[]"  value="{{date('H:i A',strtotime($music_hours->end_time))}}" class="form-control timepicker" placeholder="End Time" data-validation="required" autocomplete="off" />
                                    </td>
 ...
 -->
                            ...
                            <div class="slideRightAt boxs">
                                ...
                                <button type="submit" class="Btns">Review</button>
                            </div>
                        </div>
                        <div>
                            <div class="AllAmentities AmentitiesCheckBox Amenitiesalnew boxs">
                                ...
                                <span style="color:{{$amentitie->color_code}}">{{ucwords($amentitie->name)}}<span></label>
                                @endforeach
                                @endif
                            </div>
                        ...
                        <div class="AllAmentities AmentitiesCheckBox Amenitiesalnew boxs">
                            <h2 class="heading">Known For</h2>
                             @php $known_arr = explode(',',$business->know_for);@endphp
                                ...
                                <label>
                                    <input type="checkbox" name="know_for[]" class="radio" value="{{$known_for}}" @if(in_array($known_for,$known_arr)) checked @endif/>
...
<!--delete business-->
<div class="modal fade" id="deleteBusiness" role="dialog">
<div class="modal-dialog">
  <div class="modal-content">
  <div class="modal-body">
<form action="{{route('admin.singleDeleteBusiness')}}" method="post">
@csrf
<div class="modalContent">
 ...
 <p>Are you sure you want to delete this Business ?</p>
  ...
  <ul>
     <li><button type="submit" class="Btns">Save</button></li>
...
<script>
  ...
  //   $("#comm_0").val(val1);
  //   });
// $(".days1").on('change',function() {
//      var id = this.id;
//      var splitid = id.split('_');
//      var index1 = splitid[1];
//      var val1 = $(this).val();
//     // alert(id);
//     $("#str_days1_"+index1).val(val1);
//     });
...
//      var val1 = $(this).val();
//     // alert(id);
//     $("#str_days2_"+index1).val(val1);
//     });
// $(".days3").on('change',function() {
//      var id = this.id;
//      var splitid = id.split('_');
//      var index1 = splitid[1];
//      var val1 = $(this).val();
//     // alert(id);
//     $("#str_days3_"+index1).val(val1);
//     });
</script>
<script>
  //  $(".days").select2({
...
<script>
    ...
    $(document).ready(function() {
        $('#memuForm').on('submit', function(event) {
           ...
           $("#btn1").html('Please wait..');
            $.ajax({
                url: "{{ route('admin.saveBasicMenue') }}",
                method: "POST",
    ...
    function deleteMenue(menue_id) {
        ...
        $.ajax({
            'url': "{{route('admin.deleteAjaxMenue')}}",
            'type': 'POST',
            'data': {
                "_token": "{{ csrf_token() }}",
                "menue_id": menue_id,
...
<script>
    ...
    $(document).ready(function() {
        $('#SaveBasicDetails').on('submit', function(event) {
           // alert();
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.SaveBasicDetails')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
                ...
                'success': function(data) {
              //  alert(data);
                // var hh_status =  $("input[type=radio][name='reverse_status']:checked").val();
                // alert(hh_status);
                  // if(hh_status==1){
                    //showmsg(data.message);return false;
                    // alert('errro '+data.error_code);
                    // alert('type '+data.button_type);return false;
    ...
    $(document).ready(function() {
        $('#saveHappyDetail').on('submit', function(event) {
            ...
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.saveHappyDetail')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
    ...
    $(document).ready(function() {
        $('#saveReverseHappy').on('submit', function(event) {
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.saveReverseHappy')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
    ...
    $(document).ready(function() {
        $('#SaveBrunchDetail').on('submit', function(event) {
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.SaveBrunchDetail')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
    ...
    $(document).ready(function() {
        $('#SaveMusicDetail').on('submit', function(event) {
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.SaveMusicDetail')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
    ...
    $(document).ready(function() {
        $('#SaveAmentitiesCategory').on('submit', function(event) {
            event.preventDefault();
            $.ajax({
                'url': "{{route('admin.SaveAmentitiesCategory')}}",
                'type': 'POST',
                data: new FormData(this),
                dataType: 'JSON',
                contentType: false,
                ...
                'success': function(data) {
                    ...
                    window.location.href = "{{route('admin.businessReview',base64_encode($business->id))}}";
...
<script>
    ...
    $(function() {
        ...
        var myDropzone = new Dropzone(".dropzone", {
            url: "{{route('admin.uploadImages',$business->id)}}",
            paramName: "file",
            maxFilesize: 2,
            maxFiles: 10,
            addRemoveLinks: true,
   ...
   // var counter = 1;
    ...
    $("#addrow").on("click", function () {
      //  alert(counter);
        ...
        cols += '<td><textarea class="form-control" placeholder="Drink" name="drink[]" data-validation="required"/></textarea><input type="text" name="srt_day[]" id="tt_'+counter+'"/></td>';
...
//delete business
$('#deleteBusiness').on('show.bs.modal', function (event) {
