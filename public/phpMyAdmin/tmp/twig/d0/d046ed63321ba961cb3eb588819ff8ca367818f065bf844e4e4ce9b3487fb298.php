...
class __TwigTemplate_386e18cec3e6759eb29276a5201052b82b13b62667fd9ecffa50fa3cfc1039cf extends Template
{
    private $source;
    private $macros = [];
...
($context["foreign_max_limit"] ?? null)]);
    ...
    ";
            } elseif ((0 === twig_compare((($__internal_compile_4 =             // line 14
...
";
            ...
            // line 81
            echo "    ";
            if ((0 === twig_compare(($context["column_type"] ?? null), "date"))) {
                // line 82
                echo "        ";
                $context["the_class"] = (($context["the_class"] ?? null) . " datefield");
                // line 83
                echo "    ";
            } elseif (((0 === twig_compare(($context["column_type"] ?? null), "datetime")) || (is_string($__internal_compile_21 = ($context["column_type"] ?? null)) && is_string($__internal_compile_22 = "timestamp") && ('' === $__internal_compile_22 || 0 === strpos($__internal_compile_21, $__internal_compile_22))))) {
                // line 84
                echo "        ";
...
";
    ...
    {
        return new Source("", "table/search/input_box.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/search/input_box.twig");
    }
}
