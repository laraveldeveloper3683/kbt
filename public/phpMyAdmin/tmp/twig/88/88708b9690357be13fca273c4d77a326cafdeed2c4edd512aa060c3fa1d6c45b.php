...
class __TwigTemplate_9138f6b44b6b375d3a4196f2b0d1e06376f2393f85475faefb958c882a31ac4f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" class=\"";
        // line 2
        echo (((0 === twig_compare(($context["action"] ?? null), PhpMyAdmin\Url::getFromRoute("/table/create")))) ? ("create_table") : ("append_fields"));
        // line 3
    ...
    ";
        // line 19
        if ((0 === twig_compare(($context["action"] ?? null), PhpMyAdmin\Url::getFromRoute("/table/create")))) {
            // line 20
...
echo _gettext("Connection:");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["collation"]) {
                    ...
                    echo "\"";
                    // line 103
                    echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["collation"], "name", [], "any", false, false, false, 103), ($context["tbl_collation"] ?? null)))) ? (" selected") : (""));
                    echo ">";
                    // line 104
...
echo _gettext("Storage engine");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["engine"]) {
                ...
                // line 116
                echo ((((0 === twig_compare(twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["engine"], "name", [], "any", false, false, false, 116)), twig_lower_filter($this->env, ($context["tbl_storage_engine"] ?? null)))) || (twig_test_empty(($context["tbl_storage_engine"] ?? null)) && twig_get_attribute($this->env, $this->source, $context["engine"], "is_default", [], "any", false, false, false, 116)))) ? (" selected") : (""));
                echo ">";
                // line 117
...
($context["storage_engines"] ?? null)]));
    ...
    ";
        ...
        ";
        // line 153
        if (((0 === twig_compare(($context["action"] ?? null), PhpMyAdmin\Url::getFromRoute("/table/add-field"))) || (0 === twig_compare(($context["action"] ?? null), PhpMyAdmin\Url::getFromRoute("/table/structure/save"))))) {
            // line 154
...
";
    ...
    {
        return new Source("", "columns_definitions/column_definitions_form.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/columns_definitions/column_definitions_form.twig");
    }
}
