...
class __TwigTemplate_a69b54369981c21e795c4a338f594dad1f66e17847ce25e0ccb04a4637bc90c3 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Replication");
    ...
    ";
        ...
        // line 14
        echo "    ";
        if ((0 === twig_compare(($context["num_favorite_tables"] ?? null), 0))) {
            // line 15
            echo "        ";
...
";
    ...
    {
        return new Source("", "database/structure/body_for_table_summary.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/database/structure/body_for_table_summary.twig");
    }
}
