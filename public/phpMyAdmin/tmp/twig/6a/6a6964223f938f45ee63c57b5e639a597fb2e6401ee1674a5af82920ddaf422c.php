...
class __TwigTemplate_7d6275a86b669e584382ab9f5d827437c5c3c1c793c52ff2c5708d9d195ca7ec extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Password Hashing:");
          ...
          <td>
            ...
            foreach ($context['_seq'] as $context["plugin_name"] => $context["plugin_description"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare($context["plugin_name"], ($context["orig_auth_plugin"] ?? null)))) ? (" selected") : (""));
                echo ">";
    ...
    ";
        ...
        if ((($context["is_new"] ?? null) && ($context["has_more_auth_plugins"] ?? null))) {
            // line 56
            echo "      <div";
            echo (((0 !== twig_compare(($context["orig_auth_plugin"] ?? null), "sha256_password"))) ? (" class=\"hide\"") : (""));
...
";
    ...
    {
        return new Source("", "server/privileges/change_password.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/server/privileges/change_password.twig");
    }
}
