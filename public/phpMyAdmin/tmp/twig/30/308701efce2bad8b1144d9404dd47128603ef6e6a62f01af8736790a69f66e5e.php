...
/* import.twig */
class __TwigTemplate_b0ec75654b60ce3cfc54a2050b955e95daa44998098fdfb5e420fa1a264fa276 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <form id=\"import_file_form\" action=\"";
        ...
        // line 22
        if ((0 !== twig_compare(($context["handler"] ?? null), "PhpMyAdmin\\Plugins\\Import\\Upload\\UploadNoplugin"))) {
...
echo _gettext("Character set of the file:");
        ...
        if (($context["is_encoding_supported"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                echo "\"";
                if (((twig_test_empty(($context["import_charset"] ?? null)) && (0 === twig_compare($context["charset"], "utf-8"))) || (0 === twig_compare($context["charset"], ($context["import_charset"] ?? null))))) {
                    echo " selected";
                }
                echo ">";
                // line 108
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["charset"], "getName", [], "method", false, false, false, 116), "utf8"))) ? (" selected") : (""));
                echo ">";
                // line 117
...
";
    ...
    {
        return new Source("", "import.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/import.twig");
    }
}
