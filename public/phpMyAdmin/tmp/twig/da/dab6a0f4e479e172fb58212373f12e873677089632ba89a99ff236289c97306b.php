...
class __TwigTemplate_df1e784173436758f0d452c69ed8e6fe35b1497d84ded7296f545621859b6ecf extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Create");
  ...
  ";
        // line 43
        if ((0 !== twig_compare(($context["db"] ?? null), "mysql"))) {
            // line 44
...
echo _gettext("Collation");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["collation"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare(($context["db_collation"] ?? null), twig_get_attribute($this->env, $this->source, $context["collation"], "getName", [], "method", false, false, false, 204)))) ? (" selected") : (""));
                echo ">
                      ";
                // line 205
...
";
    ...
    {
        return new Source("", "database/operations/index.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/database/operations/index.twig");
    }
}
