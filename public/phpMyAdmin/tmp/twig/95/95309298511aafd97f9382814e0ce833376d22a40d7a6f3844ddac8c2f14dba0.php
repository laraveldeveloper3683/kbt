...
class __TwigTemplate_f5c223263a324c3413f9fac41634a1ddfb124502248b6c4a18e5f5db9a025522 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Action");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["partition"]) {
                ...
                if (($context["has_description"] ?? null)) {
                    ...
                    // line 51
                    echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["partition"], "getMethod", [], "method", false, false, false, 51), "LIST"))) ? (" IN (") : (" < "));
                    // line 52
                    ...
                    // line 53
                    echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["partition"], "getMethod", [], "method", false, false, false, 53), "LIST"))) ? (")") : (""));
                    // line 54
                    echo "</code>
                            </td>
                        ";
...
";
    ...
    {
        return new Source("", "table/structure/display_partitions.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/structure/display_partitions.twig");
    }
}
