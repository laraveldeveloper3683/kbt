...
class __TwigTemplate_5d4ff6f34e92be19eeb67340fa0550a055c9ac842ba030404c010f4d76443365 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        if (((isset($context["submit_attribute"]) || array_key_exists("submit_attribute", $context)) && (0 !== twig_compare(($context["submit_attribute"] ?? null), false)))) {
            // line 2
            echo "    ";
...
($context["extracted_columnspec"] ?? null), "attribute", [], "array", true, true, false, 7)) {
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            echo "\"";
            // line 18
            echo (((0 === twig_compare(($context["attribute"] ?? null), twig_upper_filter($this->env, (($__internal_compile_4 = ($context["attribute_types"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[$context["i"]] ?? null) : null))))) ? (" selected=\"selected\"") : (""));
            echo ">
            ";
            // line 19
...
";
    ...
    {
        return new Source("", "columns_definitions/column_attribute.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/columns_definitions/column_attribute.twig");
    }
}
