...
class __TwigTemplate_34cb446371d2b8305760e695ad4d914ac417129dd9b55b3d63268dd4ab4cc925 extends Template
{
    private $source;
    private $macros = [];
...
($context["column"] ?? null), "True_Type", [], "any", false, false, false, 16)) || twig_in_filter("set", twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "True_Type", [], "any", false, false, false, 16)))) {
  ...
  <td>
    ";
        // line 28
        if (((0 === twig_compare(twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "Null", [], "any", false, false, false, 28)), "YES")) &&  !($context["read_only"] ?? null))) {
            // line 29
...
") : (""));
        ...
        ";
                // line 62
                if ((twig_in_filter("text", twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 62)) && (1 === twig_compare(twig_length_filter($this->env, ($context["special_chars"] ?? null)), 32000)))) {
                    // line 63
                    echo "          </td>
          <td>
          ";
echo _gettext("Because of its length,<br> this column might not be editable.");
                ...
                // line 67
                echo "      ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 67), "enum"))) {
                // line 68
                echo "        ";
                echo ($context["backup_field"] ?? null);
                echo "
        ...
        ";
                // line 70
                if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "Type", [], "any", false, false, false, 70)), 20))) {
                    // line 71
            ...
            ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["enum_value"]) {
                        ...
                        echo "\"";
                        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 74), ($context["enum_selected_value"] ?? null)))) ? (" selected") : (""));
                        echo ">";
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 74), "html", null, true);
                        echo "</option>
            ";
        ...
        ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["enum_value"]) {
                        ...
                        echo "')\"";
                        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 79), ($context["enum_selected_value"] ?? null)))) ? (" checked") : (""));
                        echo ">
            <label for=\"field_";
                        // line 80
                        echo twig_escape_filter($this->env, ($context["id_index"] ?? null), "html", null, true);
          ...
          ";
                ...
                // line 83
                echo "      ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 83), "set"))) {
                // line 84
                echo "        ";
                echo ($context["backup_field"] ?? null);
                echo "
...
($context["column"] ?? null), "is_blob", [], "any", false, false, false, 97) || (1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "len", [], "any", false, false, false, 97), ($context["limit_chars"] ?? null))))) {
                    // line 98
                    echo "          ";
                    echo ($context["backup_field"] ?? null);
                    echo "
...
";
    ...
    {
        return new Source("", "table/insert/column_row.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/insert/column_row.twig");
    }
}
