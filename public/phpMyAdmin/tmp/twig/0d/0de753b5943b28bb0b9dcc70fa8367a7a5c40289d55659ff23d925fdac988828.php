...
class __TwigTemplate_0493a5288db2badc7233400cae044fcc6723131b86d07e71a5dcdcc07d97780d extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("and then");
      ...
      <td class=\"text-nowrap align-middle\">
        <select name=\"after_insert\" class=\"control_at_footer\">
          <option value=\"back\"";
        // line 19
        echo (((0 === twig_compare(($context["after_insert"] ?? null), "back"))) ? (" selected") : (""));
        echo ">";
echo _gettext("Go back to previous page");
        echo "</option>
          <option value=\"new_insert\"";
        // line 20
        echo (((0 === twig_compare(($context["after_insert"] ?? null), "new_insert"))) ? (" selected") : (""));
        echo ">";
echo _gettext("Insert another new row");
        ...
        if ( !twig_test_empty(($context["where_clause"] ?? null))) {
            ...
            echo (((0 === twig_compare(($context["after_insert"] ?? null), "same_insert"))) ? (" selected") : (""));
            echo ">";
echo _gettext("Go back to this page");
            ...
            if ((($context["found_unique_key"] ?? null) && ($context["is_numeric"] ?? null))) {
                ...
                echo (((0 === twig_compare(($context["after_insert"] ?? null), "edit_next"))) ? (" selected") : (""));
                echo ">";
...
";
    ...
    {
        return new Source("", "table/insert/actions_panel.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/insert/actions_panel.twig");
    }
}
