...
class __TwigTemplate_d4b082ac1ef8622b727ddc55c187cce0aaf3903a242b7fad6b67f693a5dfe9b4 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
      ...
      <tr>
        ...
        ";
            // line 11
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, ($context["navigation"] ?? null), "number_total_page", [], "any", false, false, false, 11), 1))) {
                // line 12
...
echo _gettext("All");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["navigation"] ?? null), "max_rows", [], "any", false, false, false, 55), $context["option"]))) ? (" selected") : (""));
                echo ">";
                echo twig_escape_filter($this->env, $context["option"], "html", null, true);
                echo "</option>
              ";
      ...
      <fieldset class=\"pma-fieldset\">
        <div class=\"formelement\">
          <div>
            ...
            echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
            echo "\" value=\"P\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 128), "pftext", [], "any", false, false, false, 128), "P"))) ? (" checked") : (""));
            echo ">
...
echo _gettext("Partial texts");
          ...
          <div>
            ...
            echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
            echo "\" value=\"F\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 132), "pftext", [], "any", false, false, false, 132), "F"))) ? (" checked") : (""));
            echo ">
        ...
        ";
            ...
            <div>
              <input type=\"radio\" name=\"relational_display\" id=\"relationalDisplayRadioK";
                ...
                echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
                echo "\" value=\"K\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 140), "relational_display", [], "any", false, false, false, 140), "K"))) ? (" checked") : (""));
                echo ">
...
echo _gettext("Relational key");
            ...
            <div>
              <input type=\"radio\" name=\"relational_display\" id=\"relationalDisplayRadioD";
                ...
                echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
                echo "\" value=\"D\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 144), "relational_display", [], "any", false, false, false, 144), "D"))) ? (" checked") : (""));
                echo ">
          ...
          ";
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 171), "possible_as_geometry", [], "any", false, false, false, 171)) {
              ...
              <input type=\"radio\" name=\"geoOption\" id=\"geoOptionRadioGeom";
                ...
                echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
                echo "\" value=\"GEOM\"";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 173), "geo_option", [], "any", false, false, false, 173), "GEOM"))) ? (" checked") : (""));
                echo ">
...
echo _gettext("Geometry");
          ...
          ";
            ...
            echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
            echo "\" value=\"WKT\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 178), "geo_option", [], "any", false, false, false, 178), "WKT"))) ? (" checked") : (""));
            echo ">
...
echo _gettext("Well Known Text");
          ...
          <div>
            ...
            echo twig_escape_filter($this->env, ($context["unique_id"] ?? null), "html", null, true);
            echo "\" value=\"WKB\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["headers"] ?? null), "options", [], "any", false, false, false, 182), "geo_option", [], "any", false, false, false, 182), "WKB"))) ? (" checked") : (""));
            echo ">
...
";
    ...
    {
        return new Source("", "display/results/table.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/display/results/table.twig");
    }
}
