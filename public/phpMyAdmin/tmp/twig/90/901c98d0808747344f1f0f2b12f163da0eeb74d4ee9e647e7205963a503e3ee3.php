...
class __TwigTemplate_b9224f4abab77865d07b00dcff6d49cf9ade03d9a9caeee8bf08cb89d03c1c17 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Index choice:");
        ...
        echo ">
                ";
        // line 41
        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 41), "PRIMARY")) ||  !twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "hasPrimary", [], "method", false, false, false, 41))) {
            // line 42
            echo "                  <option value=\"PRIMARY\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 42), "PRIMARY"))) ? (" selected") : (""));
            echo ">PRIMARY</option>
                ";
        }
        // line 44
        echo "                <option value=\"INDEX\"";
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 44), "INDEX"))) ? (" selected") : (""));
        echo ">INDEX</option>
                <option value=\"UNIQUE\"";
        // line 45
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 45), "UNIQUE"))) ? (" selected") : (""));
        echo ">UNIQUE</option>
                <option value=\"SPATIAL\"";
        // line 46
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 46), "SPATIAL"))) ? (" selected") : (""));
        echo ">SPATIAL</option>
                <option value=\"FULLTEXT\"";
        // line 47
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 47), "FULLTEXT"))) ? (" selected") : (""));
...
echo _gettext("Index type:");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["index_type"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getType", [], "method", false, false, false, 89), $context["index_type"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["index_type"], "html", null, true);
            echo "</option>
                ";
...
echo _gettext("Ignore");
            ...
            foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                // line 167
                echo "                                    ";
                if ((((0 !== twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 167), "FULLTEXT")) || preg_match("/(char|text)/i",                 // line 168
$context["field_type"])) && ((0 !== twig_compare(twig_get_attribute($this->env, $this->source,                 // line 169
...
$context["field_type"], ($context["spatial_types"] ?? null))))) {
                    ...
                    echo "\"";
                    // line 173
                    if ((0 === twig_compare($context["field_name"], twig_get_attribute($this->env, $this->source, $context["column"], "getName", [], "method", false, false, false, 173)))) {
                        // line 174
            ...
            echo "                            </select>
                        ...
                        <td>
                            <input type=\"text\"
                                ...
                                value=\"";
            // line 188
            (((0 !== twig_compare(twig_get_attribute($this->env, $this->source,             // line 187
...
$context["column"], "getSubPart", [], "method", false, false, false, 188), "html", null, true))) : (print ("")));
        ...
        // line 192
        echo "                ";
        if ((1 === twig_compare(($context["add_fields"] ?? null), 0))) {
            // line 193
            echo "                    ";
            $context['_parent'] = $context;
...
echo _gettext("Ignore");
                ...
                foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                    ...
                    // line 208
                    echo "                                        <option value=\"";
                    echo twig_escape_filter($this->env, (((isset($context["col_index"]) || array_key_exists("col_index", $context))) ? (                    // line 209
($context["col_index"] ?? null)) : ($context["field_name"])), "html", null, true);
                    echo "\"";
                    // line 210
                    echo (((0 === twig_compare(($context["j"] ?? null), $context["i"]))) ? (" selected=\"selected\"") : (""));
                    echo ">
                                            ";
                    // line 211
                    echo twig_escape_filter($this->env, $context["field_name"], "html", null, true);
...
";
    ...
    {
        return new Source("", "table/index_form.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/index_form.twig");
    }
}
