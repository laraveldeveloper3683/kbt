...
class __TwigTemplate_872c2523779aee2a1ee9c1b6c9829c55f3a1a0431a62165eb86d2f6cca955a52 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Effective");
            ...
            echo "
                ";
            // line 43
            if (((isset($context["tot_size"]) || array_key_exists("tot_size", $context)) && (0 === twig_compare(($context["mergetable"] ?? null), false)))) {
                // line 44
                echo "                    <tr>
                        <th class=\"name\">";
echo _gettext("Total");
            ...
            // line 53
            echo "                ";
            if ((((isset($context["free_size"]) || array_key_exists("free_size", $context)) && ((((0 === twig_compare(            // line 54
($context["tbl_storage_engine"] ?? null), "MYISAM")) || (0 === twig_compare(            // line 55
($context["tbl_storage_engine"] ?? null), "ARIA"))) || (0 === twig_compare(            // line 56
($context["tbl_storage_engine"] ?? null), "MARIA"))) || (0 === twig_compare(            // line 57
($context["tbl_storage_engine"] ?? null), "BDB")))) || ((0 === twig_compare(            // line 58
($context["tbl_storage_engine"] ?? null), "INNODB")) && (0 === twig_compare(($context["innodb_file_per_table"] ?? null), true))))) {
                // line 59
...
echo _gettext("Format");
            ...
            echo "</th>
                    ";
            // line 85
            if ((0 === twig_compare((($__internal_compile_2 = ($context["showtable"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["Row_format"] ?? null) : null), "Fixed"))) {
                // line 86
                echo "                        <td class=\"value\">";
echo _gettext("static");
                echo "</td>
                    ";
            } elseif ((0 === twig_compare((($__internal_compile_3 =             // line 87
...
echo _gettext("Options");
            ...
            echo "</th>
                    ";
            // line 98
            if ((0 === twig_compare((($__internal_compile_6 = ($context["showtable"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["Create_options"] ?? null) : null), "partitioned"))) {
                // line 99
                echo "                        <td class=\"value\">";
...
($context["showtable"] ?? null), "Avg_row_length", [], "array", true, true, false, 125)) && (1 === twig_compare((($__internal_compile_9 =         // line 126
...
($context["showtable"] ?? null), "Rows", [], "array", true, true, false, 136)) && (1 === twig_compare((($__internal_compile_13 =         // line 137
($context["showtable"] ?? null)) && is_array($__internal_compile_13) || $__internal_compile_13 instanceof ArrayAccess ? ($__internal_compile_13["Rows"] ?? null) : null), 0))) && (0 === twig_compare(        // line 138
...
";
    ...
    {
        return new Source("", "table/structure/display_table_stats.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/structure/display_table_stats.twig");
    }
}
