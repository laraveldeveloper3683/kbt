...
class __TwigTemplate_60455a2f85050879eb717d1f88381123c85336ff51fdebebc86092dc7a228aba extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Storage engine");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["engine"]) {
            ...
            // line 141
            echo ((((0 === twig_compare(twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["engine"], "name", [], "any", false, false, false, 141)), twig_lower_filter($this->env, ($context["storage_engine"] ?? null)))) || (twig_test_empty(($context["storage_engine"] ?? null)) && twig_get_attribute($this->env, $this->source, $context["engine"], "is_default", [], "any", false, false, false, 141)))) ? (" selected") : (""));
            echo ">";
            // line 142
...
echo _gettext("Collation");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["collation"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare(($context["tbl_collation"] ?? null), twig_get_attribute($this->env, $this->source, $context["collation"], "getName", [], "method", false, false, false, 159)))) ? (" selected") : (""));
                echo ">
                    ";
                // line 160
      ...
      ";
        ...
        if (($context["has_pack_keys"] ?? null)) {
          ...
          <div class=\"col-6\">
            ...
            // line 181
            echo (((0 === twig_compare(($context["pack_keys"] ?? null), "DEFAULT"))) ? (" selected") : (""));
            echo ">DEFAULT</option>
              <option value=\"0\"";
            // line 182
            echo (((0 === twig_compare(($context["pack_keys"] ?? null), "0"))) ? (" selected") : (""));
            echo ">0</option>
              <option value=\"1\"";
            // line 183
            echo (((0 === twig_compare(($context["pack_keys"] ?? null), "1"))) ? (" selected") : (""));
            echo ">1</option>
            </select>
          </div>
        </div>
      ...
      ";
        ...
        if (($context["has_checksum_and_delay_key_write"] ?? null)) {
          ...
          <input class=\"form-check-input\" type=\"checkbox\" name=\"new_checksum\" id=\"new_checksum\" value=\"1\"";
            // line 191
            echo (((0 === twig_compare(($context["checksum"] ?? null), "1"))) ? (" checked") : (""));
            echo ">
        ...
        <div class=\"mb-3 form-check\">
          <input class=\"form-check-input\" type=\"checkbox\" name=\"new_delay_key_write\" id=\"new_delay_key_write\" value=\"1\"";
            // line 196
            echo (((0 === twig_compare(($context["delay_key_write"] ?? null), "1"))) ? (" checked") : (""));
            echo ">
      ...
      ";
        ...
        if (($context["has_transactional_and_page_checksum"] ?? null)) {
          ...
          <input class=\"form-check-input\" type=\"checkbox\" name=\"new_transactional\" id=\"new_transactional\" value=\"1\"";
            // line 203
            echo (((0 === twig_compare(($context["transactional"] ?? null), "1"))) ? (" checked") : (""));
            echo ">
        ...
        <div class=\"mb-3 form-check\">
          <input class=\"form-check-input\" type=\"checkbox\" name=\"new_page_checksum\" id=\"new_page_checksum\" value=\"1\"";
            // line 208
            echo (((0 === twig_compare(($context["page_checksum"] ?? null), "1"))) ? (" checked") : (""));
            echo ">
        ...
        if ( !twig_test_empty(($context["row_formats"] ?? null))) {
          ...
          <div class=\"col-12\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row_format"]) {
                ...
                echo "\"";
                echo (((0 === twig_compare($context["row_format"], twig_upper_filter($this->env, ($context["row_format_current"] ?? null))))) ? (" selected") : (""));
                echo ">";
                echo twig_escape_filter($this->env, $context["row_format"], "html", null, true);
                echo "</option>
              ";
...
echo _gettext("Checksum table");
    ...
    ";
        // line 361
        if ((0 === twig_compare(($context["storage_engine"] ?? null), "INNODB"))) {
            // line 362
            echo "      <li class=\"list-group-item\">
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["value"] => $context["description"]) {
              ...
              <input class=\"form-check-input\" type=\"radio\" name=\"partition_operation\" id=\"partitionOperationRadio";
                ...
                echo "\"";
                echo (((0 === twig_compare($context["value"], "ANALYZE"))) ? (" checked") : (""));
                echo ">
...
";
    ...
    {
        return new Source("", "table/operations/index.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/operations/index.twig");
    }
}
