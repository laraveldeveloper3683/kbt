...
class __TwigTemplate_bd91e9aeda30af381c076814854c844a2dbe14b44a7ecb0b46791acc2e98c9d2 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/database/export/index.twig");
    }
}
