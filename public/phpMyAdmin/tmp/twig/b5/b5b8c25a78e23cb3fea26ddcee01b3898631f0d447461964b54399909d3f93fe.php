...
/* indexes.twig */
class __TwigTemplate_0a0e7b70fccfc947190bface4cee33b1a83a4cb7f5a8651e10a39943698cf12a extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            ";
              ...
              <td rowspan=\"";
                ...
                ";
                // line 43
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["index"], "getName", [], "method", false, false, false, 43), "PRIMARY"))) {
                    // line 44
                    echo "                  ";
...
($context["url_params"] ?? null), ($context["index_params"] ?? null)), PhpMyAdmin\Html\Generator::getIcon("b_drop", _gettext("Drop")), ["class" => "drop_primary_key_index_anchor ajax"]);
              ...
              ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                    // line 69
                    echo "                ";
                    if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 69), 1))) {
                        // line 70
                        echo "                  <tr class=\"noclick\">
                ";
                    }
                ...
                ";
                    // line 82
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 82), 1))) {
                        // line 83
                        echo "                  <td rowspan=\"";
                        echo twig_escape_filter($this->env, ($context["columns_count"] ?? null), "html", null, true);
                        echo "\">";
...
";
    ...
    {
        return new Source("", "indexes.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/indexes.twig");
    }
}
