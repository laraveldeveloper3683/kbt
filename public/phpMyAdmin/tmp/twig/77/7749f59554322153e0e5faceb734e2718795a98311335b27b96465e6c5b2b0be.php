...
class __TwigTemplate_59522411fca6000c6c576dc497f508af11dcca6676c14e6c9b989b472f1058b7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <li class=\"nav-item\">
      <a href=\"";
            ...
            echo (((0 === twig_compare(($context["route"] ?? null), "/table/structure"))) ? (" active") : (""));
            echo "\">
        ";
            // line 5
    ...
    <li class=\"nav-item\">
      <a href=\"";
            ...
            echo (((0 === twig_compare(($context["route"] ?? null), "/table/relation"))) ? (" active") : (""));
            echo "\">
        ";
            // line 11
...
";
    ...
    {
        return new Source("", "table/page_with_secondary_tabs.twig", "/var/www/html/kbt/public/phpMyAdmin/templates/table/page_with_secondary_tabs.twig");
    }
}
