...
Route::post('other-checkout-pickup-address', 'FlowerBySubscriptionController@otherCheckoutPickupAddressByGoogle');
...
Route::get('/accountadmin/customers/family/add/{id}', 'Accountadmin\CustomerController@family_add')->name('accountadmin.customers.family.add')->middleware(['auth', 'admin']);
Route::post('/accountadmin/customers/family/store', 'Accountadmin\CustomerController@family_store')->name('accountadmin.customers.family.store')->middleware(['auth', 'admin']);
Route::any('/accountadmin/customers/family/edit/{id}', 'Accountadmin\CustomerController@family_edit')->name('accountadmin.customers.family.edit')->middleware(['auth', 'admin']);
Route::any('/accountadmin/customers/family/delete/{id}', 'Accountadmin\CustomerController@family_delete')->name('accountadmin.customers.family.delete')->middleware(['auth', 'admin']);
Route::post('/accountadmin/customers/family/update', 'Accountadmin\CustomerController@family_store')->name('accountadmin.customers.family.update')->middleware(['auth', 'admin']);
...
Route::post('/accountadmin/customers/comments/update', 'Accountadmin\CustomerController@commentUpdate')->name('accountadmin.comments.customers.update')->middleware(['auth', 'admin']);
